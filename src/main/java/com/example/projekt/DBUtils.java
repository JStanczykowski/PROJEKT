...
public class DBUtils {
    public static void changeScene(ActionEvent event, String fxmlFile, String title, String username, int i, int i1) {
        Parent root = null;
        if(username != null) {
            try {
            ...
            if (!resultSet.isBeforeFirst()) {
                ...
                while (resultSet.next()) {
                    ...
                    if (retreivedPassword.equals(password)) {
                        changeScene(event, "hello-view.fxml", "zalogowano", username, 600, 400);
                    } else {
